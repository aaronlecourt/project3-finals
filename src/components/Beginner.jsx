...
const Beginner = () => {
    ...
    return (
        <div class="flex overflow-x-auto whitespace-no-wrap p-3 scrollbar-thin scrollbar-thumb-orange-500 scrollbar-track-transparent">
            {beginner.map((exercise) => (
                <div class="flex-shrink-0 w-64 mx-2 bg-slate-50/10 p-3 rounded-lg">
                    <div className="inline-flex gap-3 items-center">
                        <div className="bg-orange-500 px-1 font-poppins text-sm text-slate-950 rounded-full">B</div>
                        <div>
